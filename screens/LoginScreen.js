...
const logIn = async () => {
    try {
      ...
      if (result.type === 'success') {
        ...
        console.log(res.additionalUserInfo.profile.email, res.additionalUserInfo.profile.name,res.user.uid )
        ...
        firebase.auth().onAuthStateChanged(async (user) => {
          if (user != null) 
          console.log(user.xa)  // user access token
          // Do other things
        });
...
const LoginScreen = props => {
    ...
    return (
        <View style = {styles.container}>
            <Image source = {require('../assets/fabian-gieske-cbIKeuURaq8-unsplash.png')} style={styles.image}/>
            ...
            <View style = {styles.content}>
                ...
                <TouchableOpacity style = {styles.buttonContainer} activeOpacity = {1} onPress = {authHandler}>
                ...
                <View style = {styles.socialAuth}>
                    ...
                    <View style = {styles.socialContainer}>
                        ...
                        <View style = {{ height: 63,width: 63,borderRadius: 63, overflow: 'hidden',backgroundColor: 'red',alignItems:'center',justifyContent:'center'}}>
                            <Image source = {require('../assets/google.png')} style = {styles.googleIcon}/>
                        </View>
                        </TouchableWithoutFeedback>

                        <TouchableWithoutFeedback onPress = {logIn}>
                        <Image source = {require('../assets/images.png')} style = {styles.fbIcon} />
                        </TouchableWithoutFeedback>
                    </View>
                </View>
            </View>
