    ...
    return(
        <View style = {styles.container}>
            ...
            <View style = {styles.dotContainer}>
             ...
             <Text style = {styles.welcome}>Make friends</Text>
             <Text style = {styles.description}>Post, chat and share your moments with your paw friends</Text>
             <View style = {styles.mainButtonContainer}>
                <TouchableOpacity style = {styles.buttonContainer} activeOpacity = {1} onPress = {() => {props.navigation.navigate('third')}}>
